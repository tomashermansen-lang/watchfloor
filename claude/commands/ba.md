...
- **Run predecessor context loading (Step 0.8)** — read REQUIREMENTS.md, QA_REPORT.md,
  ...
  was actually delivered. Use this to ensure new requirements build on (not conflict
  with) established interfaces, and account for any drift from original specs.
